...
if (isSiteBlockEditor()) {
  ...
  const maybeRefreshData = nextLocation => {
    ...
    const currentTemplatePartLangMatch = currentPostId === null || currentPostId === void 0 ? void 0 : currentPostId.match(langSlugRegex);
    ...
    const nextTemplatePartLangMatch = nextPostId === null || nextPostId === void 0 ? void 0 : nextPostId.match(langSlugRegex);
